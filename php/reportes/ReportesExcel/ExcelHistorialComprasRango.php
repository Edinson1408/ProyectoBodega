...
header('Content-Disposition: attachment; filename=COMPRAS_'.$mes.'_'.$año.'.xls');
...
//titutlo
$objSheet->setCellValue('A4', 'Compras DEL  '.$mes.' al '.$año.'');
...
$objSheet->setCellValue('G5', 'Proveedor');
...
foreach ($ListaHistorial as $dato ) {	
	...
	$objSheet->setCellValue('G'.$numero, $dato['NOMPROVEEDOR']);
