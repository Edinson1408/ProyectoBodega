...
header('Content-Disposition: attachment; filename=VENTAS_'.$mes.'_'.$año.'.xls');
...
$ListaHistorial=$ObjReporteV->HistorialVentasRango($mes,$año);
...
//titutlo
$objSheet->setCellValue('A4', 'VENTAS DEL  '.$mes.' al '.$año.'');
