...
$html.='<th>Fecha</th>';
$html.='</tr>';
$SQL_FACTURA=mysql_query("SELECT a.*, b.NOMBRE_PRODUCTO, c.FECHA_FACTURA FROM  detalle_boleta as a, producto as b, boleta as c WHERE a.COD_PRODUCTO=b.COD_PRODUCTO AND a.NRO_FACTURA=c.NRO_FACTURA AND c.FECHA_FACTURA='$FECHA_HOY' AND c.ID_TURNO='$ID_TURNO' order by a.NRO_FACTURA ",$conexion);
