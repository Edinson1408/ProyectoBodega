...
<div class="container-fluid">
	<div class="nota">
		<H4>REPORTES DE COMPRAS MENSUALES</H4>
	</div>
...
RepVentasHPdfExcel=(e)=>
{
	...
	else
	{
		...
		{
			let DataString=$('#RepVentasHF').serialize();
			window.open('reportes/ReportesPdf/PdfHistorialCompras.php?'+DataString);
		}else{
			let DataString=$('#RepVentasHF').serialize();
			window.open('reportes/ReportesExcel/ExcelHistorialCompras.php?'+DataString);
		}
