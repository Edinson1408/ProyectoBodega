			...
			$stock=$Ojb.CANTIDAD;
				...
				if (valida=='NO')
				{
					$('#ContenidoGrilla').append(`
						...
						<td> 
							<input class='sinborde' id='CodProducto${Conta}' name='CodProducto${Conta}' value='${$Ojb.CODPRODUCTO}' readonly> 
						</td>
						...
						<td> 
						<input  class="sinborde" type='text' id='PrecioVenta${Conta}' name='PrecioVenta${Conta}' value='${$Ojb.PRECIOCOMPRA}' readonly>
						</td>
						<td> 
							<input  class="sinborde" type='text' id='Importe${Conta}' name='Importe${Conta}' value='${$Ojb.PRECIOCOMPRA}' readonly>
						</td>
						</tr>`);
