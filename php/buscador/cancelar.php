...
$boleta=$_GET['id'];
$sql_boleta=mysql_query("SELECT SUM(CANTIDAD_PRODUCTO) AS CANTI,COD_PRODUCTO FROM detalle_boleta WHERE NRO_FACTURA='$boleta' GROUP BY COD_PRODUCTO ",$conexion);
...
mysql_query("DELETE FROM boleta WHERE NRO_FACTURA='$boleta'",$conexion);
mysql_query("DELETE FROM detalle_boleta WHERE NRO_FACTURA='$boleta'",$conexion);
