...
<?php
	...
	$consulta=mysql_query("SELECT A.*,B.NOMBRE_PRODUCTO AS PRODUCTO FROM  detalle_factura AS A, producto AS B WHERE A.COD_PRODUCTO=B.COD_PRODUCTO AND  NRO_FACTURA='$id'",$conexion);
