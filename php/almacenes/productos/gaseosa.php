...
<table class="table table-bordered" >
	...
	$sql=mysql_query("SELECT a.*,b.NOMBRE_PRODUCTO FROM almacen AS a, producto AS b WHERE a.COD_PRODUCTO=b.COD_PRODUCTO AND a.COD_CLASIFICACION='3'",$conexion);
	while ($f=mysql_fetch_array($sql)) {
		echo "<tr>";
			echo "<td>".$f['COD_PRODUCTO']."</td>";
