...
<table class="table table-bordered" >
	...
	$sql=mysql_query("SELECT a.*,b.NOMBRE_PRODUCTO FROM almacen AS a, producto AS b WHERE a.COD_PRODUCTO=b.COD_PRODUCTO AND a.COD_CLASIFICACION='2'",$conexion);
